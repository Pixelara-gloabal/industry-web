    ...
    <div className="bg-[#0b0d0e] text-white min-h-screen">
      ...
      <main className="mx-auto max-w-[1440px] px-5 py-14 sm:px-8 lg:px-12">
        ...
        <div className="grid gap-8 lg:grid-cols-[0.7fr_1.3fr]">
          <aside className="tech-card p-6 sm:p-8 h-fit">
            <p className="text-[11px] font-mono text-[#f3a329] font-bold">COMPANY OVERVIEW</p>
            ...
            <div className="mt-6 space-y-3.5 border-t border-white/10 pt-5 text-xs text-[#c1c6ca]">
              <div className="flex items-center gap-3">
                <Factory className="size-4 text-[#f3a329]" />
                <span>120,000 sq ft Production Facility</span>
              </div>
              <div className="flex items-center gap-3">
                <Globe2 className="size-4 text-[#f3a329]" />
                <span>Deployments in 40+ Countries</span>
              </div>
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span>Carl Zeiss PRISMO 3D CMM Lab</span>
              </div>
            </div>
          </aside>

          <div className="space-y-6">
            <article className="tech-card p-6 sm:p-8">
              <span className="text-[11px] font-mono text-[#f3a329] font-bold">01 / OUR FOUNDATION</span>
            ...
            <article className="tech-card p-6 sm:p-8">
              <span className="text-[11px] font-mono text-[#f3a329] font-bold">02 / MANUFACTURING CAPABILITY</span>
              <h2 className="mt-2 text-xl sm:text-2xl font-extrabold tracking-tight text-white">
            ...
            <article className="tech-card p-6 sm:p-8">
              <span className="text-[11px] font-mono text-[#f3a329] font-bold">03 / GLOBAL EXPORT &amp; SUPPORT</span>
              <h2 className="mt-2 text-xl sm:text-2xl font-extrabold tracking-tight text-white">
        ...
        <div className="mt-14 text-center">
          <Link
            href="/contact#quote"
            className="inline-flex items-center gap-3 bg-[#f3a329] px-8 py-4 text-xs font-bold tracking-[0.1em] text-[#0b0d0e] hover:bg-[#ffc368] transition-all rounded-md shadow-lg shadow-[#f3a329]/20 cursor-pointer active:scale-95"
          >
